...
class VeiculoControllerTest {
    ...
    void testCadastrarVeiculoComSucesso() {
        ...
        VeiculoDTO resultado = veiculoController.cadastrarVeiculo(input);
    ...
    @Test
    void testCadastrarVeiculoComInputNulo() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            veiculoController.cadastrarVeiculo(null);
        });

        assertEquals("O objeto input não pode ser nulo", exception.getMessage());
    }
    ...
    void testAtualizarVeiculoComSucesso() {
        ...
        // Execução do método do controlador
        VeiculoDTO resultado = veiculoController.atualizarVeiculo(1L, input);
    ...
    void testDeletarVeiculoComSucesso() {
        ...
        // Execução do método do controlador
        boolean resultado = veiculoController.deletarVeiculo(1L);
